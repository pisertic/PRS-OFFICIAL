...
// CONSTRUCTORS *****************************************************
  ...
  {
	  System.out.println("Calling AbstractClient's Constructor");
...
// INSTANCE METHODS *************************************************
  ...
  {
	  System.out.println("Calling AbstractClient's openConnection()");
  ...
  {
	System.out.println("Calling AbstractClient's sendToServer()");
  ...
  {
	  System.out.println("Calling AbstractClient's closeConnection()");
      readyToStop= true; 
      closeAll();
  }
...
// ACCESSING METHODS ------------------------------------------------
  ...
  {
	System.out.println("Calling AbstractClient's isConnected()");
  ...
  {
	System.out.println("Calling AbstractClient's getPort()");
    return port;
  }
  ...
  {
	System.out.println("Calling AbstractClient's setPort()");
    this.port = port;
  }
  ...
  {
	  System.out.println("Calling AbstractClient's getHost()");
	  return host;
  }
  ...
  {
	System.out.println("Calling AbstractClient's setHost()");
    this.host = host;
  }
  ...
  {
	System.out.println("Calling AbstractClient's getInetAddress()");
...
// RUN METHOD -------------------------------------------------------
  ...
  {
	  System.out.println("Calling AbstractClient's run()");
...
// METHODS TO BE USED FROM WITHIN THE FRAMEWORK ONLY ----------------
  ...
  final private void closeAll() throws IOException
  {
    // This method is final since version 2.2
	  System.out.println("Calling AbstractClient's closeAll()");
    try
    {
      //Close the socket
